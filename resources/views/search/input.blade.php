    ...
    <div class="max-w-7xl mx-auto sm:w-8/12 md:w-1/2 lg:w-5/12">
      <div class="bg-whiteoverflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200  ">
          ...
          <form class="mb-6">
            @csrf
            <button id="keyword-search-button" class="bg-blue-500 text-white font-bold py-2 px-4 rounded" type="button">
              キーワード検索
            </button>
          ...
          <form>
              <button id="prefecture-search-button" class="bg-blue-500 text-white font-bold py-2 px-4 rounded">
                都道府県で検索する
              </button>
                <select placeholder="東京都" id="prefecture-select" name="prefecture" class="block mt-1 w-full  text-white font-bold py-2 px-4 rounded">
